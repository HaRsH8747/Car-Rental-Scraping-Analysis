...
public class AvisCanadaWebCrawler {
    ...
    private String userPickUpInput;
    private String userDropOffInput;
    ...
    public AvisCanadaWebCrawler(WebDriver webDriver, WebDriverWait wait) {
...
//            System.out.println("all data saved...");
    ...
    public Hashtable<String, String> scrapData(String url, String fileName, String folderName, String pickupLocation, String dropOffLocation, String pickupDate, String returnDate) {
        this.url = url;
...
//        }
        ...
        userPickUpInput = pickupLocation;
        userDropOffInput = dropOffLocation;
        userPickupDate = pickupDate;
        ...
        WebElement inputPickUpField = driver.findElement(By.id("PicLoc_value"));
//        WebElement inputDropOffField = driver.findElement(By.id("DropLoc_value"));
//        WebElement inputPickUpDateField = driver.findElement(By.id("from"));
//        WebElement inputReturnDateField = driver.findElement(By.id("to"));

        inputPickUpField.sendKeys(userPickUpInput);
//        inputDropOffField.sendKeys(userDropOffInput);
//        inputPickUpDateField.sendKeys(userPickupDate);
//        inputReturnDateField.sendKeys(userReturnDate);
