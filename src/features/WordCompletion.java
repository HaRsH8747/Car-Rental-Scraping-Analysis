...
class TrieNode {
    ...
    public TrieNode() {
        this.children = new TrieNode[128]; // Considering ASCII characters
...
class Trie {
    ...
    public List<String> getSuggestions(String prefix) {
        ...
        suggestions.sort(Comparator.comparingInt(suggestion -> calculateLevenshteinDistance(prefix, suggestion)));
